...
# filter eicu_time by hospital 167 or hospital 420
eicu_time = eicu_time[(eicu_time['hospitalid'] == 167) | (eicu_time['hospitalid'] == 420)]
...
eicu_lab_time.to_csv('eicu_lab_time_167_420.csv', index=False)