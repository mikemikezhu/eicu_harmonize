...
patient_medication = patient_medication[patient_medication["hospitalid"].isin([252,165])]
...
patient = patient[patient["hospitalid"].isin([252,165])]
...
eicu_lab_time.to_csv('eicu_lab_time_252_165.csv', index=False)