...
patient_medication = patient_medication[patient_medication["hospitalid"].isin([199,458])]
...
patient = patient[patient["hospitalid"].isin([199,458])]
...
eicu_lab_time.to_csv('eicu_lab_time_199_458.csv', index=False)